...
%         \left(\left[\left(L\mathrm{\dot\theta}-x_{1}\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta\sin(\beta)}\right)
%         +\frac{L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)^4\right]_{-L}^0\right.\\
%         &\left.-\left[\left(L\mathrm{\dot\theta}-x_{1}\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta\sin(\beta)}\right)+\frac{3L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)^4\right]_{-L}^0\right) =
%     \end{split}
% \end{equation}
...
% \begin{equation}
%     \begin{split}
%         \frac{c}{3\dot\theta\cos(\beta)}*\frac{1}{\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta\sin(\beta)}\right)}*&\left(\left(L\mathrm{\dot\theta}+\frac{L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)^4\right.\\
...
%         &\left.+\left(L\mathrm{\dot\theta}+L\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta\sin(\beta)}\right)+\frac{3L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)^4\right)
%     \end{split}
% \end{equation}
...
% \begin{equation}
%     \begin{split}
%         \frac{c}{3\dot\theta\cos(\beta)}*\frac{1}{\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta\sin(\beta)}\right)}*&\left({\left(L\mathrm{\dot\theta}+\frac{3L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}+L\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta}\sin\left(\beta \right)\right)\right)}^4-\right.\\
%         &\left(L\mathrm{\dot\theta}+\frac{L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}+L\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta}\sin\left(\beta \right)\right)\right)^4+\\
%         &\left(L\mathrm{\dot\theta}+\frac{L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)^4-\\
%         &\left.\left(L\mathrm{\dot\theta}+\frac{3L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)^4\right) = A
%     \end{split}
% \end{equation}
...
% \begin{equation}
%     \begin{split}
%         &-\frac{c}{3\mathrm{\dot\theta}{\cos\left(\beta \right)}^2\left(\mathrm{\dot\phi}+\mathrm{\dot\theta}\sin\left(\beta \right)\right)}*\left(\left(L\mathrm{\dot\theta}+\frac{L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}+L\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta}\sin\left(\beta \right)\right)\right)^4\right.\\
%         &\left.-{\left(L\mathrm{\dot\theta}+\frac{3L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}+L\cos\left(\phi \right)\left(\mathrm{\dot\phi}+\mathrm{\dot\theta}\sin\left(\beta \right)\right)\right)}^4-{\left(L\mathrm{\dot\theta}+\frac{L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)}^4+{\left(L\mathrm{\dot\theta}+\frac{3L\mathrm{\dot\theta}\cos\left(\beta \right)}{2}\right)}^4\right)
%     \end{split}
% \end{equation}
